...
const serpGroups = [
  {
    ...
    note: 'Высококонкурентная выдача — 8 промо-объявлений на странице',
    results: [
      {
        brand: 'GURIAN',
        domain: 'gurian.ru',
      ...
      {
        brand: 'Cvet Fantasy',
        domain: 'cvetfantasy.ru',
        path: '› вазоны... Промо',
        title: 'Купить уличные вазоны для цветов. Вертикальное...',
        desc: 'Опыт производства более 15 лет. Высокая прочность материала · Минимальные цены. Гарантия. Стойкость к ультрафиолету',
        rating: null,
        reviews: null,
        tags: ['Кадки под гранит', 'Вертикальные конструкции', 'Фитомодуль', 'Фотогалерея'],
        phone: '+7 (4742) 37-XX-XX',
        hours: 'будни 9:00–17:00',
        metro: null,
        icon: '🌱',
        iconBg: 'bg-green-700',
      },
    ...
    conclusion: 'Запрос «купить уличные вазоны» — самый конкурентный: 6+ промо-объявлений на первом экране. Лидер по рейтингу — Marble Collection (5,0), у большинства конкурентов рейтинга нет вовсе. Наш сниппет — единственный с явным указанием рейтинга 4,5 и отзывов среди производителей пластика, но заголовок стоит усилить словом «уличные» в начале и указать скидку, как в других наших объявлениях.',
  },
  {
    ...
    results: [
      ...
      },
      {
        brand: 'BOSSAGE',
        domain: 'bossage.ru',
        path: '› Вазон-уличный-бетон... Промо',
        title: 'Купить бетонный, уличный вазон для цветов. Доставка МАФ...',
        desc: 'Купить бетонный вазон для цветов уличный от крупнейшего производителя МАФ BOSSAGE. Собственное производство. Крупнейший производитель. Огромный выбор',
        rating: null,
        reviews: null,
        tags: ['Высокопрочный бетон', 'Производство', 'Выбор покрытия', 'Другие МАФ'],
        phone: '+7 (343) 211-XX-XX',
        hours: 'пн-ср 9:00–18:00, перерыв 10:00–10:02 · чт 9:00–18:00, перерыв 10:00–10:02 · пт 9:00–18:00',
        metro: 'м. Геологическая, Екатеринбург',
        icon: '🧱',
        iconBg: 'bg-slate-700',
      },
    ...
    conclusion: 'По коммерческому запросу «большие вазоны купить» в топе преобладают производители из бетона и полимербетона: Marble Collection лидирует по рейтингу (5,0), а Bossage делает акцент на локальном производстве в Екатеринбурге. Наш сниппет уступает по рейтингу только Marble Collection, но выигрывает по цене — стоит добавить конкретную цифру скидки в заголовок и указать присутствие в регионе, как у Bossage.',
  },
];
